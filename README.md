...
- 승패 룰
    - 💡 '버스트' 상태: 가진 카드 숫자의 합이 21을 초과하는 경우
    - [x] 버스트 상태가 되면 패배한다.
        - [x] 딜러와 참여자가 둘 다 버스트한 경우 딜러의 승리다.
    - 💡 '블랙잭' 상태: 처음 받은 2장의 합이 21인 경우
    - 참여자가 블랙잭 상태로 이기는 경우, 딜러에게 베팅 금액의 1.5배를 받는다.
        - 소숫점 금액은 버린다.
    - 딜러는 블랙잭 상태로 이겨도, 참여자에게 베팅한 금액만큼만 받는다.
    - 딜러와 참여자가 동시에 '블랙잭' 상태인 경우 무승부다.
